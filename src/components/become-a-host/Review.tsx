      ...
      <div className="container mx-auto px-4 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Section title="Address">
            ...
            <Field label="Latitude" value={form.address.latitude} />
            <Field label="Longitude" value={form.address.longitude} />
          </Section>
        </div>
        ...
        <div className="flex justify-between items-center ">
          ...
          <button
            ...
            className="bg-[#DE3151] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#dd2e57] transition-colors duration-300"
          >
            Publish
          </button>
        </div>
